...
while ($data = mysqli_fetch_array($sql)) {
    ?>                <div class="col-3" >
                    <div class="card"><img class="card-img-top w-100 d-block" style="width: 200px; height: 200px" src="<?php echo $data['gambar']; ?>">
                        <div class="card-body">
                            <h4 class="card-title"><?php echo $data['nama']; ?></h4>
                            <p class="deskripsi"><?php echo $data['descri']; ?></p>
                            <p class="card-text">Rp. <?php echo $data['harga'] ?></p>
                            <form class="form-inline" method="post" action="cart.php?id=<?php echo $data['id']; ?>">
                             <div class="form-group mx-sm-3 mb-2"  >
                              <input style="max-width:90px" type="number" class="form-control" name="jumlah" min="5" placeholder="Qty">
                             </div>
